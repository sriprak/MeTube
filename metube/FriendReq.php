...
echo $name."</a><b/><br/>";
echo "<b><a style=\"color: #000000; font-size: 08pt\" href=\"FriendControl.php?id=$id&cat=app\">";
echo "APPROVE</a><b/><br>";
echo "<b><a style=\"color: #000000; font-size: 08pt\" href=\"FriendControl.php?id=$id&cat=ign\">";
echo "IGNORE</a><b/><br/>";
}
echo "</div>";
?>
