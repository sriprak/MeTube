...
$q = mysql_query("SELECT mid,uid,Title,MediaPath,Type,UserName FROM `Media` m natural join `userList`u where `Type` like 'image%' and permission='public' order by `UploadTime` DESC") or die(mysql_error());
while ($row = mysql_fetch_assoc($q)){
	...
	$views = 0;
            ...
            echo "<div class='rbox'>";
            echo "<br/><img style=\"float:left; margin:0px auto;\" src=\"$path\" alt=\"profile\" height=\"100\" width=\"100\" />";
